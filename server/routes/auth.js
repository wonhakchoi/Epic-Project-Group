...
router.use(function (req, res, next) {
    ...
    res.header("Access-Control-Allow-Origin", "https://easy-eats-deploy-git-main-imvanwendy.vercel.app"); // update to match the domain you will make the request from
