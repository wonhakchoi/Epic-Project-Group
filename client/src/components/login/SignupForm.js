...
const SignupForm = () => {
    ...
    const { error, user, loggedIn } = useSelector((state) => state.authentication.authentication);
    ...
    const errorMsg = value => {
        if (!value) {
            return (
                <Alert severity="error">This is a required field!</Alert>
            );
        }
    };
    ...
    //         <Alert
    //             action={
    //                 <Button href="/" variant="contained" color="inherit" size="small">
    //                     HOME
    //                 </Button>
    //             }
    //         >
